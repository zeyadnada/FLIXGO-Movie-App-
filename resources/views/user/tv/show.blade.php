...
@section('title', 'Movie-App | ' . $show['name'])
    ...
    <section class="section details">
        ...
        <div class="container">
            <div class="row">
                <!-- title -->
                <div class="col-12">
                    <h1 class="details__title">{{ $show['name'] }}</h1>
                </div>
                <!-- end title -->
                            ...
                            <div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-7">
                                <div class="card__content">
                                    ...
                                    <ul class="card__meta">
                                        ...
                                        <li>{{ \Carbon\Carbon::parse($show['first_air_date'])->year . ' - ' . \Carbon\Carbon::parse($show['last_air_date'])->year }}
                                        </li>
                                        <li><span>No. of seasons:</span> {{ $show['number_of_seasons'] }}</li>
                                        <li>
                                            <span>No. of episodes:</span>
                                            {{ $show['number_of_episodes'] }}
                                            {{ !empty($show['episode_run_time']) ? '(' . $show['episode_run_time'][0] . ' min)' : '' }}
                                        </li>

                                        <li><span>Country:</span> <a href="#">{{ $show['origin_country'][0] }}</a>
                                        </li>
                                    </ul>
                ...
                <div class="col-12 col-xl-6">
                    <iframe id="player" width="560" height="315"
                        src="{{ count($show['videos']['results']) > 0 ? 'https://www.youtube.com/embed/' . $show['videos']['results'][0]['key'] : 'https://www.youtube.com' }}"
                        frameborder="0"
            ...
            <div class="row">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="1-tab">
                            ...
                            <div class="gallery" itemscope>
                                <div class="row">
                                    <!-- Cast item -->
                                    @forelse ($show['credits']['cast'] as $cast)
                                        @if ($loop->index < 12)
                                ...
                                <div class="col-12">
                                    <div class="reviews">
                                        <ul class="reviews__list">
                                            ...
                                            @forelse ($show['reviews']['results'] as $review)
                        ...
                        <div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="3-tab">
                            ...
                            <div class="gallery" itemscope>
                                <div class="row">
                                    <!-- gallery item -->
                                    @forelse ($show['images']['backdrops'] as $image)
                                        @if ($loop->index < 12)
                ...
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="row">
                        ...
                        <!-- card -->
                        @forelse ($show['recommendations']['results'] as $recomendShow)
                            <div class="col-6 col-sm-4 col-lg-6">
                                <div class="card">
                                    <div class="card__cover">
                                        <img src="{{ $recomendShow['poster_path']
                                            ? 'https://image.tmdb.org/t/p/w500/' . $recomendShow['poster_path']
                                            ...
                                            alt="poster">
                                        <a href="{{ route('shows.show', $recomendShow['id']) }}" class="card__play">
                                            <i class="icon ion-ios-play"></i>
                                        </a>
                                    </div>
                                    <div class="card__content">
                                        <h3 class="card__title"><a
                                                href="{{ route('shows.show', $recomendShow['id']) }}">{{ $recomendShow['title'] }}</a>
                                        </h3>
                                        <span class="card__rate"><i class="icon ion-ios-star"></i>
                                            {{ number_format($recomendShow['vote_average'], 1) }}</span>
                                    </div>
                                </div>
                            </div>
                        @empty
